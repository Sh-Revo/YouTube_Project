...
import com.youtube.response.parcer.forSearchDescription.SearchDescription;
...
public class Video extends ListCell<String> implements Config, HttpConfig {
    private Button view;
    ...
    public Video(SimpleResponse searchResult) throws IOException {
        ...
        try(Response response = client.newCall(new Request.Builder()
            ...
            SearchDescription apiResponse = mapper.readValue(response.body().bytes(), new TypeReference<SearchDescription>(){});
